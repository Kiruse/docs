...
## PowerSocket
An abstraction of WebSocket clients based on the native WebSocket API. It provides a solid, stateful
foundation to help integration developers to maintain connections to full nodes.

As a consumer of the SDK, you will likely never need the `PowerSocket` class itself.
